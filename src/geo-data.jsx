...
const REFERENCE_FORMATIONS = [
  ...
  },
  {
    ...
    title: 'Listric fault',
    tag: 'Fault · curved',
    caption: 'A fault that steepens at surface and flattens with depth into a near-horizontal sole. Dip is reported at surface; the curve and its terminating low-angle segment are visible in the overlay.',
    overlays: ['dip-at-surface', 'dip-at-depth', 'curve-trace'],
    cameraHint: { phi: 1.1, theta: 0.0, dist: 10 },
    model: {
      layers: [
        { id: 'L1', name: 'Sandstone', lithology: 'sandstone', thickness: 0.6, order: 0 },
      ...
      events: [
        { id: 'F1', type: 'fault', subtype: 'listric', strike: 0,
          dip: 70, dip_at_depth: 10, dip_direction: 90, throw: 0.7, order: 0,
          description_source: 'A listric normal fault: 70° at surface, flattening to ~10° at depth.',
          field_origin: { strike: 'inferred', dip: 'stated', dip_at_depth: 'stated', dip_direction: 'stated', throw: 'inferred' } },
      ],
    },
  },
