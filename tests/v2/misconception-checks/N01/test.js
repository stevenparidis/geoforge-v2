// N01: Valid horizontal layer (negative)
// Stub returns a single horizontal layer with no validation_note.
// Test verifies that .validation-note-pill does NOT appear anywhere.
...
const FIXTURE = {
  meta: { name: 'Horizontal Sandstone Layer', description: 'A horizontal sandstone layer 2m thick.' },
  layers: [
    {
      id: 'L1', name: 'Sandstone', lithology: 'sandstone', thickness: 2.0, order: 0,
      description_source: 'A horizontal sandstone layer 2m thick.',
...
async function run() {
  ...
  try {
    ...
    await textarea.fill('A horizontal sandstone layer 2m thick.');
    ...
    console.log(`PASS ${TEST_ID}: no .validation-note-pill for valid horizontal layer`);
