// M04: Thrust not steep dip (positive)
// Stub returns a thrust fault with dip 70 and validation_note set.
...
const FIXTURE = {
  meta: { name: 'Thrust Steep Dip', description: 'A thrust fault dipping 70° east.' },
  layers: [
    {
      id: 'L1', name: 'Limestone', lithology: 'limestone', thickness: 1.0, order: 0,
      description_source: 'A thrust fault dipping 70° east.',
      field_origin: { thickness: 'inferred', lithology: 'inferred' },
    },
  ],
  events: [
    {
      id: 'E1', type: 'fault', subtype: 'thrust', strike: 0, dip: 70, dip_direction: 90, throw: 0.5, order: 0,
      description_source: 'A thrust fault dipping 70° east.',
      field_origin: { strike: 'inferred', dip: 'stated', dip_direction: 'stated', throw: 'inferred' },
      validation_note: 'Thrust faults typically dip <45°; 70° is unusually steep. This may be a reverse fault.',
    },
  ],
};
...
async function run() {
  ...
  try {
    ...
    await textarea.fill('A thrust fault dipping 70° east.');
    ...
    console.log(`PASS ${TEST_ID}: .validation-note-pill visible for thrust steep dip misconception`);
