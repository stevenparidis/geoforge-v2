// M03: Strike/dip independence (positive)
// Stub returns a fault event with strike 45, dip_direction 200, and validation_note set.
...
const FIXTURE = {
  meta: { name: 'Strike Dip Independence', description: 'A fault with strike 045° and dip direction 200°.' },
  layers: [
    {
      id: 'L1', name: 'Sandstone', lithology: 'sandstone', thickness: 1.0, order: 0,
      description_source: 'A fault with strike 045° and dip direction 200°.',
      field_origin: { thickness: 'inferred', lithology: 'inferred' },
    },
  ],
  events: [
    {
      id: 'E1', type: 'fault', subtype: 'normal', strike: 45, dip: 60, dip_direction: 200, throw: 0.5, order: 0,
      description_source: 'A fault with strike 045° and dip direction 200°.',
      field_origin: { strike: 'stated', dip: 'inferred', dip_direction: 'stated', throw: 'inferred' },
      validation_note: 'By the right-hand rule, a fault striking 045° must dip in the 135° (SE) direction, not 200°.',
    },
  ],
};
...
async function run() {
  ...
  try {
    ...
    await textarea.fill('A fault with strike 045° and dip direction 200°.');
    ...
    console.log(`PASS ${TEST_ID}: .validation-note-pill visible for strike/dip independence misconception`);
