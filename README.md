...
4. **Listric fault dip-at-depth overlay** approximates the curved profile with a quadratic interpolation between surface and depth dips, rendered as a profile line. A fully geodetically correct curve is out of scope for v1.
